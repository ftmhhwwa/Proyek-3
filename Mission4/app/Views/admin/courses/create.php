...
<?= $this->section('content') ?>
    ...
    <form id="create-course-form" action="/admin/courses/store" method="post">
        <div class="form-group">
            <label for="course_name">Nama Mata Kuliah:</label>
            <input type="text" id="course_name" name="course_name" class="form-control">
            <div class="error-message" id="error-course_name"></div>
        </div>
        
        <div class="form-group">
            <label for="credits">SKS:</label>
            <input type="number" id="credits" name="credits" class="form-control">
            <div class="error-message" id="error-credits"></div>
        </div>
